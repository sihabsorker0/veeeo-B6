  ...
  if (!isAuthenticated) {
    return (
      <div className="p-8 text-center">
        <i className="ri-time-line text-5xl text-gray-400 dark:text-gray-600 mb-4"></i>
        <h2 className="text-2xl font-bold mb-2">Watch Later</h2>
    ...
    <div className="p-4">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <i className="ri-time-line text-5xl text-gray-400 dark:text-gray-600 mb-4"></i>
          <h3 className="text-xl font-medium">No videos saved for later</h3>
